            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header text-center">
                        <i class="bi bi-exclude"> <span class="spanCreate"> Welcome To Edit Lesson</span></i>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('learning.update', $learning_edit->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label class="bi bi-person-fill-add col-form-label col-md-2 LabForm"> Lesson Class</label>
                                <div class="col-md-10">
