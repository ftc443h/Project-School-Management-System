                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('student.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-10">
                                    <input type="file" value="{{old('photo_student')}}" name="photo_student" class="form-control place">
                                </div>
                            </div>
                            <div class="form-group row ">
                                <label class="bi bi-building-fill-add col-form-label col-md-2 LabForm"> ID</label>
                                <div class="col-md-10">
                                    <input type="text" name="code_student" class="form-control place" placeholder="Input student">
                                </div>
                            </div>
                            <div class="form-group row ">
                                <label class="bi bi-person-plus-fill col-form-label col-md-2 LabForm"> Student</label>
                                <div class="col-md-10">
                                    <input type="text" name="name_student" class="form-control place" placeholder="Input Name student">
                                </div>
                            </div>
                            <div class="form-group row ">
                                <label class="bi bi-calendar3 col-form-label col-md-2 LabForm"> Birth</label>
                                <div class="col-md-10">
                                    <input type="date" name="birthday_student" class="form-control place">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-md-10">
                                    <input type="text" name="email_student" class="form-control place" placeholder="Input E-Mail Invalid">
                                </div>
                            </div>
                            <div class="form-group row ">
                                <label class="bi bi-phone-flip col-form-label col-md-2 LabForm"> Telephone</label>
                                <div class="col-md-10">
                                    <input type="text" name="phone_student" class="form-control place" placeholder="Input No Telephone">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="bi bi-house col-form-label col-md-2 LabForm"> Address</label>
                                <div class="col-md-10">
                                    <textarea class="form-control place" name="address_student" cols="30" placeholder="Input Address Invalid" rows="10"></textarea>
                                </div>
                            </div>
